...
// MARK: - App Icon Generator for Vitaly

/// Generates a premium sunburst app icon with Vitaly brand colors
/// Design: Radiating sunburst with stylized "V" or pure geometric sunburst
/// Style: WHOOP-inspired dark premium aesthetic

let iconSize: CGFloat = 1024.0
let outputPath = "/Users/tonsaj/Workspace/iOSHealth/iOSHealth/Resources/Assets.xcassets/AppIcon.appiconset/AppIcon.png"

// Vitaly Brand Colors
let primaryColor = CGColor(red: 0.95, green: 0.45, blue: 0.25, alpha: 1.0)  // #F27340
let secondaryColor = CGColor(red: 0.98, green: 0.6, blue: 0.45, alpha: 1.0)  // #FA9973
let tertiaryColor = CGColor(red: 1.0, green: 0.78, blue: 0.65, alpha: 1.0)   // #FFC7A6
let backgroundDark = CGColor(red: 0.05, green: 0.05, blue: 0.07, alpha: 1.0) // #0D0D12
...
func createAppIcon() {
    ...
    // MARK: - Sunburst Design
    // Create elegant radiating sunburst with brand gradient
    ...
    for i in 0..<numberOfRays {
        ...
        // Ray width varies based on position
        ...
        // Choose color based on ray position for gradient effect
    ...
    // MARK: - Center Circle with Gradient
    // Main central circle with warm gradient
    ...
    // MARK: - Stylized "V" Symbol (Optional - can be enabled)
    // Uncomment below to add a minimalist "V" in the center
    /*
    context.setStrokeColor(backgroundDark)
    context.setLineWidth(iconSize * 0.022)
    context.setLineCap(.round)
    context.setLineJoin(.round)

    let vHeight = centerRadius * 0.8
    let vWidth = centerRadius * 0.7
    let vTop = center.y - vHeight * 0.3
    ...
    */
    ...
    if CGImageDestinationFinalize(destination) {
        print("✓ App icon successfully generated at: \(outputPath)")
        print("✓ Size: 1024x1024")
        print("✓ Design: Sunburst with Vitaly brand gradient")
    } else {
